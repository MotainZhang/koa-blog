<template>
  <div id="login">
  	<lottie :options="defaultOptions" :height="200" :max-width="460" v-on:animCreated="handleAnimation" style="position: relative;top: 17%;" />
...
import * as animationData from "../../../assets/lottle/bike.json";
